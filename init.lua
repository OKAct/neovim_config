...
require("lazy").setup({
	...
	},
	{
		...
		config = function()
			...
			--  - Autocompletion
			--  - Symbol Search
			--  - and more! Thus, Language Servers are external tools that must be installed separately from Neovim. This is where `mason` and related plugins come into play.
			--
...
vim.keymap.set("i", "<C-d>", "<Esc>:update<CR>", { silent = true })
